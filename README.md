...
Для установки проекта нужно клонировать репозиторий, затем создать виртуальное окружение:
<br/>
...
> Нужно скачать приложение Miniconda, но также можно установить Anaconda.
> После этого необходимо ознакомиться с документацией CUDA и cuDNN и скачать правильную версию этих утилит для вашей видеокарты.
...
> Он содержит заголовок и инструкции в виде комментариев.
